...
def main():
    ...
    if args.data_name == 's3dis':
        ...
        Scannetv2(split='train', data_root=args.data_root, test_area=args.test_area )
        Scannetv2(split='val', data_root=args.data_root, test_area=args.test_area )
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.distributed:
        ...
        args.batch_size = int(args.batch_size / ngpus_per_node) #将batch_size按照节点均分
    ...
    if args.data_name == 's3dis':
       ...
       train_transform = t.Compose([t.RandomScale([0.9, 1.1]), t.RandomDropColor(),t.RandomRotate()])
       train_data =Scannetv2 (split='train', data_root=args.data_root, test_area=args.test_area, voxel_size=args.voxel_size, transform=train_transform, shuffle_index=True, loop=args.loop)
    if main_process():
